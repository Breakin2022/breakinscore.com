  ...
  <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="panel-heading">
                <h3 style="margin-bottom: 26px;"> <span class="pull-left">Matches List</span> <span> <a href="{{route('match.create')}}" class="btn btn-primary btn-xs pull-right">add Match</a> </span></h3>
            </div> <!-- /panel-heading -->
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr id="del{{$match->id}}">
                        <td>{{$i++}}</td>
                        <td id="red{{$match->redtid}}">{{$match->redtid}}</td>
                        <td id="red{{$match->bluetid}}">{{$match->bluetid}}</td>
                        {{-- <td>{{$judges->bluetid}}</td> --}}
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-xs btn-edit bg-purple hidden-xs hidden-sm" href="{{route('match.edit', $match->id)}}" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                            <a class="btn btn-delete btn-xs bg-red hidden-xs hidden-sm" href="#" onclick="deljudges({{$match->id}})"><i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                            ...
                            <i class="fa fa-caret-down"></i></button>
                                ...
                                <ul class="dropdown-menu slidedown">
                                    <li><a href="{{route('judges.edit', $match->id)}}"> Edit</a></li>
                                    <li><a onclick="deljudges({{$match->id}})"> Delete</a></li>
                                </ul> <!-- /slidedown -->
                            </div> <!-- /btn-group -->
                        </td>
                    </tr>
