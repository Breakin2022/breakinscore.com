  ...
  <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="panel-heading">
                <h3 style="margin-bottom: 26px;"> <span class="pull-left">Edit Sponsors</span></h3>
            </div> <!-- /panel-heading -->
            <div class="panel-body m-t-0">

            <form method="POST" action="{{route('sponsors.update', $sponsors[0]->id)}}" enctype="multipart/form-data">
            {{method_field('PUT')}}
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              ...
              <div class="row">
                      <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control" id="title" value="{{$sponsors[0]->title}}" name="title" required="">
                      </div>
                </div>
            <div class="row">
                    <div class="form-group col-md-4">
                        <label for="image">Image</label>
                        <input type="file" class="form-control" id="image" value="" name="image" required="">
                    </div>
              </div>
            <div class="row">
                    <div class="form-group col-md-4">
                        <label for="link">link</label>
                        <input type="text" class="form-control" id="link" value="{{$sponsors[0]->link}}" name="link" required="">
                    </div>
              </div>
