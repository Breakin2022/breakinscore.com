  ...
  <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="panel-heading">
                <h3 style="margin-bottom: 26px;"> <span class="pull-left">Participant List</span> <span> <a href="{{route('participant.create')}}" class="btn btn-primary btn-xs pull-right">add participant</a> </span></h3>
            </div>
