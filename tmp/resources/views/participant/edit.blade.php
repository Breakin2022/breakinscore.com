...
@section('main-section')
  ...
  <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <form method="POST" action="{{route('participant.update', $participant[0]->id)}}">
            {{method_field('PUT')}}
            ...
            <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="email" class="form-control" id="email" value="{{$participant[0]->email}}" name="email" required="">
                    </div>
              </div>
            <div class="row">
                    <div class="form-group col-md-4">
                        <label for="phone">Phone</label>
                        <input type="text" class="form-control" id="phone" value="{{$participant[0]->phone}}" name="phone" required="">
                    </div>
              </div>
              <div class="row">
                      <div class="form-group col-md-4">
                          <label for="nick">Nick Name</label>
                          <input type="text" class="form-control" id="nick" value="{{$participant[0]->nick}}" name="nick" required="">
                      </div>
              </div>
              <div class="row">
                      <div class="form-group col-md-4">
                          <label for="address">Address</label>
                          <input type="text" class="form-control" id="address" name="address" value="{{$participant[0]->address}}" required="">
                      </div>
              </div>
              <div class="row">
                      <div class="form-group col-md-4">
