          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="address" value="{{$competitionVenues[0]->address}}" name="address" required="">
                    </div>
              </div>
            <div class="row">
                    <div class="form-group col-md-4">
                        <label for="phone">Phone</label>
                        <input type="text" class="form-control" id="phone" value="{{$competitionVenues[0]->phone}}" name="phone" required="">
                    </div>
              </div>
