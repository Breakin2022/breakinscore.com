...
@section('main-section')
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <thead>
                <tr>
                    ...
                    <th style="Display: none;"></th>
                    <th title="view old round scores">View Score</th>
                    <th>Action</th>
                </tr>
            </thead>
                <tbody>
                    ...
                    <tr id="del{{$competitionVenue->id}}">
                        ...
                        <td>
                          <div class="btn-group">
                              <a class="btn btn-xs btn-primary hidden-xs hidden-sm" href="{{route('competitionScores', $competitionVenue->id)}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                          </div>
                        </td>
                        <td>
                        <div class="btn-group">
  ...
  function delcompetitionVenue(id){
    if (confirm("Are you sure you want to remove this Competition ? \nThis will also delete Related Data i.e Matches")) {
      $.ajax({
