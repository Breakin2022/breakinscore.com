  ...
  <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
              ...
              <div class="row">
                    <div class="form-group col-md-4">
                        <label for="phone">Trial  Competition</label><br>
                        <label class="radio-inline"><input type="radio" name="trial" value="1" required="">Yes</label>
                        <label class="radio-inline"><input type="radio" checked name="trial" value="0" required="">No</label>
                    </div>
              </div>
