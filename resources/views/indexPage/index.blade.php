                ...
                <table id="mytable" class="table">
                  <thead>
                    <tr>
                      ...
                      <th id="blueTeamHeading">First Team</th>
                      <th id="redTeamHeading" >Second Team</th>
                    </tr>
                  </thead>
                  ...
                  <tbody id="tableBody">
                    ...
                    @foreach ($competitions as $competition)
                      ...
                      <tr class="allCommonClass competitionBody{{$competitionId}}" >
                        <td class="teamsLabelColor">
                          {{$match->t1name }}
                           VS
                           {{ $match->t2name }}</td>
                        <td class="blueTeamColor">{{$match->t1score }}</td>
                        <td class="redTeamColor">{{$match->t2score }}</td>
                      </tr>
                      @endforeach
