  ...
  <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="panel-heading">
                <h3 style="margin-bottom: 26px;"> <span class="pull-left">Criteria List</span> <span> <a href="{{route('criteria.create')}}" class="btn btn-primary btn-xs pull-right">add Criteria</a> </span></h3>
            </div> <!-- /panel-heading -->
                  ...
                  @endphp
                    ...
                    <tr id="del{{$criteria->id}}">
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-delete btn-xs bg-red hidden-xs hidden-sm" href="#" onclick="delCriteria({{$criteria->id}})"><i class="fa fa-times" aria-hidden="true"></i></a>
                        </div>
                            ...
                            <i class="fa fa-caret-down"></i></button>
                                ...
                                <ul class="dropdown-menu slidedown">
                                    ...
                                    <li><a href="#" onclick="delCriteria({{$criteria->id}})"> Delete</a></li>
                                </ul> <!-- /slidedown -->
                            </div> <!-- /btn-group -->
                        </td>
                    </tr>
